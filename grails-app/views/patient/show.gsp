	...
	<div class="content">
		<div class="container">
			...
			<div class="LeftMargin row">
				<div class="span3">
					<div class="btn-group">
						<a href="${createLink(uri: '/patient/create')}"
							...
							<h5>
								<span class="cus-application_view_list"></span> Patient List
							</h5>
						</a>
					</div>
				</div>
				...
				<div id="show-patient"
					class="content scaffold-show topSlider alignCenter" role="main">
					<g:if test="${flash.message}">
						<div class="message" role="status">
							<span class="label label-warning"> ${flash.message}
							</span>
						</div>
					</g:if>
					...
					<dl class="dl-horizontal topSlider">
						...
						<dt>Middle Name</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="middleName" />
						</dd>
						<dt>Last Name</dt>
						<dd>
						...
						<dt>Gender</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="gender" />
						</dd>
						...
						<dt>Address City</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="address_city" />
						</dd>
						<dt>Town</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="address_town" />
						</dd>
						<dt>Province</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="address_province" />
						</dd>
						<dt>Birthdate</dt>
						<dd>
							<g:formatDate bean="${patientInstance}" field="birthDate" />
						</dd>
						<dt>Date of Registration</dt>
						<dd>
							<g:formatDate bean="${patientInstance}"
								field="dateOfRegistration" />
						</dd>
						<dt>Email Address</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="emailAddress" />
						</dd>
						<dt>Street</dt>
						<dd>
							<g:fieldValue bean="${patientInstance}" field="address_street" />
