...
<html>
	...
	<body>
		...
		<div class="nav" role="navigation">
			...
			<li><g:link class="listDeleted" action="listDeleted"><g:message code="default.list.label" args="[entityName]" /></g:link></li>
		...
		<div id="show-patient" class="content scaffold-show" role="main">
			...
			<g:form>
				<fieldset class="buttons">
					...
					<g:actionSubmit class="restore" action="restore" value="${message(code: 'default.button.restore.label', default: 'Restore')}" onclick="return confirm('${message(code: 'default.button.delete.confirm.message', default: 'Are you sure?')}');" />
				</fieldset>
			</g:form>
		</div>
	</body>
