	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<g:sortableColumn property="number" title="${message(code: 'checkUpInvoice.number.label', default: 'Number')}" />
		...
		<g:each in="${checkUpInvoiceInstanceList}" status="i" var="checkUpInvoiceInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td>${fieldValue(bean: checkUpInvoiceInstance, field: "number")}</td>
