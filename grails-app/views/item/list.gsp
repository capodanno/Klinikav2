	...
	<table class="table table-bordered">
		<thead>
			<tr>
				...
				<g:sortableColumn property="minStockLevel" title="${message(code: 'item.minStockLevel.label', default: 'Min Stock Level')}" />
		...
		<g:each in="${itemInstanceList}" status="i" var="itemInstance">
			<tr class="${(i % 2) == 0 ? 'odd' : 'even'}">
				...
				<td>${fieldValue(bean: itemInstance, field: "minStockLevel")}</td>
