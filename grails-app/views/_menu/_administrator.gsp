<ul class="nav pull-right top">
					...
					<li class="dropdown">
							...
							<ul class="dropdown-menu">
								<li><a href="#"><span class="cus-user_edit" ></span> Change Password</a></li>
								<li><a href="#"><span class="cus-cog_edit" ></span> Settings</a></li>
								<li><a href="#"><span class="cus-door_out" ></span> Sign Out</a></li>
							</ul>
						</li>
</ul>